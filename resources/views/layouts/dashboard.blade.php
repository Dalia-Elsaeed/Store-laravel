    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">Message example</a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="{{ env('APP_NAME') }}"
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            ...
                            <form action="{{ route('logout') }}" method="post">
                               ...
                               @csrf
                                <br><button type="submit" class="btn btn-sm btn-outline-primary">Logout</button>
                            </form>
                        </div>
                    </div>
                @endauth
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2025 <a href="#">Store</a>.</strong>
            All rights reserved.
        </footer>
    </div>
